...
class HarDNet(nn.Module):
    def __init__(self, depth_wise=False, arch=85):
        ...
        if arch == 85:
            ...
            raise ValueError("Only one of 85, 68 or 39 is available for arch.")
...
def hardnet_39(**kwargs):
    return HarDNet(arch=39, **kwargs)


def hardnet_68(**kwargs):
    return HarDNet(arch=68, **kwargs)


def hardnet_85(**kwargs):
    return HarDNet(arch=85, **kwargs)
